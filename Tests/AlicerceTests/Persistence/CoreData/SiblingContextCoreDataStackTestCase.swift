...
class SiblingContextCoreDataStackTestCase: XCTestCase {
    ...
    // MARK: legacyMakeContexts

    func testLegacyMakeContexts_WithInMemoryStoreType_ShouldSucceed() {
        ...
        XCTAssertNotEqual(workContext.persistentStoreCoordinator, backgroundContext.persistentStoreCoordinator)
    }

    func testLegacyMakeContexts_WithSQLiteStoreType_ShouldSucceed() {
