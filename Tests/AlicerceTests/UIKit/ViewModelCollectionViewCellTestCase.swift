...
fileprivate final class MockViewModelCollectionViewCell<ViewModel>: ViewModelCollectionViewCell<ViewModel> {
...
final class ViewModelCollectionViewCellTestCase: XCTestCase {
    func testInit_WithFrame_ShouldInvokeSetUpMethods() {
        ...
        let cell = MockViewModelCollectionViewCell<MockReusableViewModelView>()
