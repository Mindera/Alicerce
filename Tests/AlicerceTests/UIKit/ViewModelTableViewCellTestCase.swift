//
//  ViewModelTableViewCellTestCase.swift
//  Alicerce
//
...
fileprivate final class MockViewModelTableViewCell<ViewModel>: ViewModelTableViewCell<ViewModel> {
...
final class ViewModelTableViewCellTestCase: XCTestCase {
    func testInit_WithFrame_ShouldInvokeSetUpMethods() {
        ...
        let cell = MockViewModelTableViewCell<MockReusableViewModelView>()
