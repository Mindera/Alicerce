extension Log.ItemFormat {
    ...
    public enum Builder {
        ...
        @inlinable
        public static func buildExpression<O: RangeReplaceableCollection>(
            _ kp: KeyPath<Log.Item, O>
        ) -> [Formatting<O>] {
        ...
        @inlinable
        public static func buildOptional<O>(_ formatting: [Formatting<O>]?) -> [Formatting<O>] { formatting ?? [] }
